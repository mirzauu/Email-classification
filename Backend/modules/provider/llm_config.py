...
class LLMProviderConfig:
    def __init__(
        ...
        capability_overrides = {
            "supports_pydantic": self._normalize_bool_env("LLM_SUPPORTS_PYDANTIC"),
            "supports_streaming": self._normalize_bool_env("LLM_SUPPORTS_STREAMING"),
            "supports_vision": self._normalize_bool_env("LLM_SUPPORTS_VISION"),
            "supports_tool_parallelism": self._normalize_bool_env(
    ...
    def _normalize_bool_env(self, var_name: str) -> Optional[bool]:
...
class LLMConfigManager:
    ...
    def get_config_for_model(model_string: str) -> Dict[str, Any]:
        ...
        provider, _ = LLMConfigManager.parse_model_string(model_string)
        env_base_url = os.environ.get("LLM_API_BASE")
    ...
    def build_llm_provider_config(
        ...
        """
        Build an LLMProviderConfig based on environment, user prefs, and defaults.
        """
        if config_type == "chat":
            model_string = (
        ...
        provider, full_model_name = LLMConfigManager.parse_model_string(model_string)
        config_data = LLMConfigManager.get_config_for_model(full_model_name).copy()
